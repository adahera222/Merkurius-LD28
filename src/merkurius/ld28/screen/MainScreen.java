...
public class MainScreen extends GameScreen {
	...
	protected void setSystems() {
		...
		if( isServer ) {
			syncSystem = world.setSystem( new LD28SyncSystem(0.1f, 4445, true) );
		...
		syncSystem.addSyncedComponent(Transform.class, SyncTypes.Both);
		...
		syncSystem.addSyncedComponent(Input.class, SyncTypes.ClientToServer);
	}
	...
	protected void initialize() {
		...
		EntityFactoryLD28.newMap(world, 1, "data/carte_V2.tmx", -500, -1200).addToWorld();
