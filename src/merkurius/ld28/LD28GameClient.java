...
public class LD28GameClient implements GameClient {
	...
	public LD28GameClient(InetAddress address, int port, int portOut, int id, Entity ship) {
	...
	public LD28GameClient(InetAddress address, int port) {
		this.address 	= address;
		this.port 		= port;
	}
